...
0. ПРОВЕРКА — сначала проверь, не выполнена ли задача УЖЕ:
   Прочитай tasks.json и progress.md. Проверь, существуют ли файлы из acceptance_criteria.
   Если файлы уже созданы и задача по сути выполнена — сразу переходи к шагу 2 (билд).
   Если билд проходит и Audit passed — ставь done в tasks.json и выводи RALPH_COMPLETE.
